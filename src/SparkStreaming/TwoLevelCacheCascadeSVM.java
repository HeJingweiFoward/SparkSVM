...
public class TwoLevelCacheCascadeSVM {
	public static void main(String[] args) throws InterruptedException, IOException, URISyntaxException {
		...
		SparkConf conf = new SparkConf().setAppName("TwoLevelCacheCascadeSVM").setJars(new String[] { "E:\\论文实验\\mjsl1.jar" })
		...
		JavaRDD<String> lines = sc.textFile(sampleHDFSPath).repartition(12).cache();
		...
		JavaRDD<String>Positive80TrainSet= PositiveSvs.sample(false, 0.8).cache();
		JavaRDD<String>Negative80TrainSet= NegativeSvs.sample(false, 0.8).cache();
