...
public final class JavaTC {
	...
	public static void main(String[] args) {
		...
		SparkConf sparkConf = new SparkConf().setJars(new String[] { "F:\\研二\\科研\\JavaTC.jar" }).set("spark.executor.memory", "1000m");

		SparkSession spark = SparkSession.builder().appName("JavaTC").config(sparkConf).master("spark://192.168.2.151:7077").getOrCreate();
